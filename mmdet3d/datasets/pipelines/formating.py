...
class Collect3D(object):
    ...
    def __init__(self,
                 ...
                 meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                            ...
                            'transformation_3d_flow', 'img_scale', 'img_translation')):
        self.keys = keys
...
class DefaultFormatBundle3D(DefaultFormatBundle):
    ...
    def __call__(self, results):
        ...
        if 'raw_points' in results:
            results['raw_points'] = DC(results['raw_points'])
